...
video3 = Video.create(title: "GSXR vs State trooper", description: "Tickets are too expensive nowadays, alternative to save money.", views: 0, uploader_id: user_1.id)
...
video4 = Video.create(title: "RendeZook (Only in Battlefield 3 Edit)", description: "Awesome eject kill", views: 0, uploader_id: user_2.id)
...
video6 = Video.create(title: "Ofdream_Thelema", description: "Ofdream Ambient track", views: 0, uploader_id: user_1.id)
...
video8 = Video.create(title: "Hack Reactor vs App Academy", description: "Spittin facts", views: 0, uploader_id: user_2.id)
